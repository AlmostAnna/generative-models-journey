...
try:
    ...
    from .visualization import get_color_palette, plot_real_data, plot_real_and_generated, plot_energy_landscape_unified, plot_true_contour_and_samples, plot_chain_trajectories, plot_historgam, plot_comparison
