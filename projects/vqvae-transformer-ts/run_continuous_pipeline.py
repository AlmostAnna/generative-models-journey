...
def main(args):
    ...
    # Plot
    plot_continuous_samples(generated_samples, scaler, "plots/generated_samples_continuous.png")
    
    print("Continuous pipeline complete! Samples saved to plots/generated_samples_continuous.png")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Continuous Transformer for Time Series (JiT-style)")
